...
(1, 'admin', '123456',  'ItCast', ''),
(2, 'demo', '123456', 'ItCast', '');
...
(1, 'demo1', '123456', 'ItCast', ''),
(2, 'demo2', '123456', 'ItCast', '');
...
<div><img src="static/image/goods/detail/apple1.jpg" alt="商品详情1" width="1280" height="1982"><img src="static/image/goods/detail/apple2.jpg" alt="商品详情2" width="1280" height="1712"><img src="static/image/goods/detail/apple3.jpg" alt="商品详情3" width="1280" height="1982"></div>
</div>');
...
INSERT INTO `shop_goods_album` VALUES
...
CREATE TABLE `shop_car`(
		...
		`goods_id` INT UNSIGNED NOT NULL COMMENT '商品id',
		`goods_num` INT UNSIGNED DEFAULT 1 NOT NULL COMMENT '商品数量'
)ENGINE=InnoDB CHARSET=utf8mb4;
